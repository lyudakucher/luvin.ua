// window.onload = init;
    ...
    playSlider($('.around_icon_item').eq(0), product1 );
    playSlider($('.around_icon_item').eq(1), product2 );
    playSlider($('.around_icon_item').eq(2), product3 );
	...
	if (old_id !== old_id_s){
		...
		productItems.play();
		domElem.addClass('pause_around_icon_item');	
