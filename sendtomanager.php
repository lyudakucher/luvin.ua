...
$time1 = date("H:i:s"); 
        ...
        $message = '
                <html>
                    <head>
                        <title>Luvin.ua Питання до менеджера</title>
                    </head>
                    <body>
                        <p>Имя: '.$name2.'</p>
                        <p>E-mail: '.$email2.'</p>   
...
mail($to, 'Luvin.ua Питання до менеджера', $message, $headers); 
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" bgcolor="#ffffff" style="padding: 10% 10% 5% 10%">
                                ...
                                <tr>    
                                    <td align="left" style="color: #000000; font: 14px/20px  Arial,helvetica,sans-serif!important; padding:0px 0px 28px 0px;">
                                        Дякуємо за інтерес до компанії <strong>LUVIN<sup>tm</sup></strong>.<br>Ваше запитання прийнято та передано у відділ продажів.<br><br>Найближчим часом на вказаний номер '.$phone2.' зателефонує спеціаліст, розповість всі деталі та надасть відповіді на всі запитання.
                                    </td>
                                </tr>
                                <tr>    
...
mail($email2, 'Luvin.ua Питання до менеджера', $message1, $headers1);
